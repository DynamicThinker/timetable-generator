...
export function DashboardHeader({ user }: HeaderProps) {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-white/10 px-6 lg:px-8 backdrop-blur-xl bg-white/5 sticky top-0 z-40">
      <div>
        ...
        <DropdownMenuContent align="end" className="w-56 glass-card border-white/10">
          <DropdownMenuLabel>
            <div className="flex flex-col space-y-1">
              ...
              <p className="text-xs text-primary/80 capitalize font-medium">Role: {user.role}</p>
            </div>
          </DropdownMenuLabel>
